...
const errorHandler = (err, req, res, next) => {
  ...
  if (error.name === 'PlaidError')
    error = new Boom.Boom(error.error_message, { statusCode: error.status_code });
  ...
  // Log server-side failures (e.g. a failed transactions sync surfaced from a
  // webhook) so they remain observable now that routes let such errors propagate.
